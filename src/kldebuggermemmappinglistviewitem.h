...
*/
class KLDebuggerMemMappingListViewItem : public Q3ListViewItem
{
public:
    KLDebuggerMemMappingListViewItem(Q3ListView* lv, unsigned int from, unsigned int to);

    ~KLDebuggerMemMappingListViewItem();
